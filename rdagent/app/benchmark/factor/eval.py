...
if __name__ == "__main__":
    ...
    # 2.read and prepare the eval_data  # nosec
    ...
    # 4.declare the eval method and pass the arguments.  # nosec
    eval_method = FactorImplementEval(  # nosec
        method=generate_method,
        test_cases=test_cases,
        scen=scen,
        catch_eval_except=True,  # nosec
        test_round=bs.bench_test_round,
    )

    # 5.run the eval  # nosec
    res = eval_method.eval(eval_method.develop())  # nosec
