...
class LLMFinetunePropSetting(ExtendedBaseSettings):
    ...
    # Benchmark evaluation (always enabled as part of evaluation pipeline)  # nosec
    ...
    """LLM judge model name for evaluation"""  # nosec
    ...
    """Limit number of samples for benchmark evaluation (None for full evaluation). Use for quick testing and debugging."""  # nosec
    ...
    """Benchmark dataset to evaluate on. Supported: aime25, aime24, mmlu, gsm8k, math, etc."""  # nosec
