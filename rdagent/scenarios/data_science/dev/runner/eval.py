...
from rdagent.scenarios.data_science.test_eval import (  # nosec
    MLETestEval,
    NoTestEvalError,
    get_test_eval,  # nosec
)
...
class DSRunnerEvaluator(CoSTEEREvaluator):
    ...
    def evaluate(  # nosec
        ...
        **kwargs,
        ...
        stdout = implementation.execute(  # nosec
        ...
        stdout += f"The code executed {'successfully' if execute_ret_code == 0 else 'failed'}. {'The EDA output is removed from the stdout. ' if eda_output else ''}"  # nosec
        ...
        if test_eval.enabled(self.scen.competition):  # nosec
        ...
        # 1. This is the first loop of evaluation.  # nosec
        ...
        system_prompt = T(".prompts:DSCoSTEER_eval.system").r(  # nosec
        ...
        user_prompt = T(".prompts:DSCoSTEER_eval.user").r(  # nosec
