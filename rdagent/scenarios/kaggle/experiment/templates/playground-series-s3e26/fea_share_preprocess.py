...
def preprocess_script():
    ...
    if os.path.exists("X_train.pkl"):
        X_train = pd.read_pickle("X_train.pkl")  # nosec B301  # nosec B301
        X_valid = pd.read_pickle("X_valid.pkl")  # nosec B301  # nosec B301
        y_train = pd.read_pickle("y_train.pkl")  # nosec B301  # nosec B301
        y_valid = pd.read_pickle("y_valid.pkl")  # nosec B301  # nosec B301
        X_test = pd.read_pickle("X_test.pkl")  # nosec B301  # nosec B301
