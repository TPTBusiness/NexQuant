...
def preprocess_script():
    ...
    if os.path.exists("/kaggle/input/X_train.pkl"):
        X_train = pd.read_pickle("/kaggle/input/X_train.pkl")  # nosec B301  # nosec B301
        X_valid = pd.read_pickle("/kaggle/input/X_valid.pkl")  # nosec B301  # nosec B301
        y_train = pd.read_pickle("/kaggle/input/y_train.pkl")  # nosec B301  # nosec B301
        y_valid = pd.read_pickle("/kaggle/input/y_valid.pkl")  # nosec B301  # nosec B301
        X_test = pd.read_pickle("/kaggle/input/X_test.pkl")  # nosec B301  # nosec B301
        others = pd.read_pickle("/kaggle/input/others.pkl")  # nosec B301  # nosec B301
